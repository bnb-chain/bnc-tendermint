...
func TestValidateBlockHeader(t *testing.T) {
	...
	blockExec := sm.NewBlockExecutor(stateDB, log.TestingLogger(), proxyApp.Consensus(), mock.Mempool{}, sm.MockEvidencePool{}, true)
...
func TestValidateFailBlockOnCommittedEvidence(t *testing.T) {
	...
	blockExec := sm.NewBlockExecutor(stateDB, log.TestingLogger(), nil, nil, mockEvPoolAlwaysCommitted{}, true)
