...
build_c:
	CGO_ENABLED=1 go build $(BUILD_FLAGS) -tags "$(BUILD_TAGS) rocksdb" -o $(OUTPUT) ./cmd/tendermint/
...
install_c:
	CGO_ENABLED=1 go install  $(BUILD_FLAGS) -tags "$(BUILD_TAGS) rocksdb" ./cmd/tendermint
